(function () {
    ...
    <img src="${guessYokai.image}" alt="${guessYokai.name}" class="w-full h-full object-contain">
        ...
        <div class="${getColor('element')} aspect-square w-24 h-24 max-md:h-16 max-md:w-16 max-sm:w-10 max-sm:h-10 flex justify-center items-center text-base max-md:text-sm text-center break-words whitespace-normal overflow-hidden max-sm:text-[0.625rem]">
        <img src="${guessYokai.elementimage}" alt="${guessYokai.element}" class="w-12 h-12 object-contain"></div>
